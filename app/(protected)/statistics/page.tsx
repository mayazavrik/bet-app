...
import { RiseOutlined, FallOutlined, AreaChartOutlined, BarChartOutlined } from "@ant-design/icons";
...
const StatisticsPage: React.FC = () => {
	...
	const chartsData = useMemo(() => {
		...
		const dailyStats: Record<
			string,
			{ date: string; wins: number; losses: number; netProfit: number }
		> = {};
			...
			<Row gutter={[16, 16]}>
				<Col span={24}>
					<Card
						...
						className="shadow-md"
					>
						<Paragraph>График показывает изменение вашего баланса после каждой ставки.</Paragraph>
							...
							<ResponsiveContainer>
								...
								>
									...
									<Line
										...
										activeDot={{ r: 8 }}
									/>
									<Line type="monotone" dataKey="amount" stroke="#52c41a" name="Изменение" />
								</LineChart>
							</ResponsiveContainer>
						</div>
						...
						<Row gutter={16}>
							...
							<Col span={8}>
								<Statistic title="Всего ставок" value={chartsData.balanceHistory.length} />
							</Col>
							<Col span={8}>
								<Statistic
				...
				<Col span={24}>
					<Card
						...
						className="shadow-md"
					>
						<Paragraph>График показывает количество выигрышей и проигрышей по дням.</Paragraph>
						...
						<div style={{ width: "100%", height: 400 }}>
							<ResponsiveContainer>
								...
								>
									...
									<Tooltip />
									<Legend />
									<Bar dataKey="wins" name="Выигрыши" fill="#52c41a" />
									<Bar dataKey="losses" name="Проигрыши" fill="#ff4d4f" />
									<Bar dataKey="netProfit" name="Чистая прибыль" fill="#1677ff" />
								</BarChart>
							</ResponsiveContainer>
						</div>
					</Card>
