...
import { ReloadOutlined, QuestionCircleOutlined, WalletOutlined, BugOutlined } from '@ant-design/icons';
...
const BalancePage: React.FC = () => {
  ...
  // Рассчитываем ожидаемый баланс на основе истории ставок
  const calculateExpectedBalance = (): number => {
    if (balance === null) return 0;
    
    // Суммируем результаты всех завершенных ставок
    let totalBets = 0;
    let totalWins = 0;
    ...
    // Вычисляем ожидаемый баланс: начальный баланс - ставки + выигрыши
